...
public class selectgerenServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public selectgerenServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("selectgerenServlet");
		
		if(u!=null){
			req.setAttribute("u", u);
			//转发
			req.getRequestDispatcher("gerenziliao.jsp").forward(req, resp);
		}
	}
