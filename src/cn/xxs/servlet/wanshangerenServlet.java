...
public class wanshangerenServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public wanshangerenServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("完善个人资料   wanshangerenServlet");
		String tel=new String(req.getParameter("phone").getBytes("iso-8859-1"),"utf-8");
		String email=new String(req.getParameter("email").getBytes("iso-8859-1"),"utf-8");
		String identity=new String(req.getParameter("identity").getBytes("iso-8859-1"),"utf-8");
